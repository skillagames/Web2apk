...
const indexToInject = s.indexOf(targetStr);
if (indexToInject === -1) {
...
s = s.substring(0, indexToInject) + replacement + s.substring(indexToInject + targetStr.length);
fs.writeFileSync('server.ts', s);
console.log('Injected patch-index-html');
